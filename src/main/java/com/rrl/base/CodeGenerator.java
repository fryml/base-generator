...
import static com.rrl.base.core.ProjectConstant.*;
...
public class CodeGenerator {
  // JDBC配置，请修改为你项目的实际配置
  private static final String JDBC_URL = "jdbc:mysql://192.168.10.246:3306/csp_db";
  private static final String JDBC_USERNAME = "root";
  private static final String JDBC_PASSWORD = "fxzx123";
  ...
  private static final String AUTHOR = "maliang";// @author
  private static final String DATE = new SimpleDateFormat("yyyy/MM/dd").format(new Date());// @date

  public static void main(String[] args) {
//    genCode("t_corpus_info");
     genCodeByCustomModelName("t_corpus_info","CorpusInfo");
  }
  ...
  public static void genService(String tableName, String modelName) {
    try {
      ...
      File file1 =
          new File(PROJECT_PATH + JAVA_PATH + PACKAGE_PATH_SERVICE_IMPL + modelNameUpperCamel + "ServiceImpl.java");
